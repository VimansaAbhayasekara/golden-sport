...
const FAQ = [
  {
    ...
    answer: "We recommend our GS-100 Beginner Cricket Bat for new players. It's lightweight (2.7 lbs), has a large sweet spot, and comes with a 6-month warranty. Priced at just $89.99, it's perfect for developing proper technique."
  },
  {
  ...
  return (
    <>
      ...
      <Button 
        ...
        className="rounded-full fixed bottom-8 right-8 z-50 shadow-lg"
      >
        Start Chat
      </Button>
      ...
      {/* Chat Box */}
      {isOpen && (
        <Card className="fixed bottom-24 right-8 w-full max-w-md h-[500px] flex flex-col z-50 shadow-xl">
